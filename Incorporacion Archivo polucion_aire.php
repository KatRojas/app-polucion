...
$(document).ready( function () {
    $('#tabla').DataTable({
        "rowCallback": function ( row,data,index ) {
            if (data[0]<=50) {
                $('td',row).css("background-color","#33cc33");
            }
						if (data[0]>51 && data[0]<=100) {
								$('td',row).css("background-color","#ff9933");
						}
						if (data[0]>100 && data[0]<=150) {
								$('td',row).css("background-color","#ff6633");
						}
						if (data[0]>150 && data[0]<=200) {
								$('td',row).css("background-color","#ff3333");
						}
						if (data[0]>200 && data[0]<=300) {
								$('td',row).css("background-color","#cc00cc");
						}
						if (data[0]>300 && data[0]<=500) {
								$('td',row).css("background-color","#990099");
						}
						if (data[0]>500) {
								$('td',row).css("background-color","#660066");
						}
        }
			}
		);
...
<div class="container">
    <div class="page-header">
        <h1 id="timeline">Niveles De Polucion</h1><a href=" https://www.airnow.gov/">airnow.go</a>
    </div>
    <ul class="timeline">
        <li>
        ...
        <li class="timeline-inverted">
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              <h4 class="timeline-title">Arriesgado "300-500+"</h4>
            </div>
            <div class="timeline-body">
